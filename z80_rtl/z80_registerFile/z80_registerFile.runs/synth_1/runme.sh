...
HD_PWD='C:/Users/mille/Vivado/z80_registerFile/z80_registerFile.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log z80RegisterFile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source z80RegisterFile.tcl
