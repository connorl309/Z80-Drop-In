...
HD_PWD='C:/Users/mille/Vivado/z80_registerFile/z80_registerFile.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log z80RegisterFile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source z80RegisterFile.tcl -notrace
